						...
						<form id="signupform" autocomplete="off" method="post" action="insert-user.php"  class="form_container left_label">
							<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input id="username" name="login_username" type="text"  maxlength="50" class="large"/>
									</div>
								</div>
								</li>
								<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input id="password" name="login_password" type="password" maxlength="50" value="" class="large"/>
									</div>
								</div>
								</li>
								<li>
							   ...
							   <div class="form_grid_12">
									...
									<div class="form_grid_4">
											<input name="pno" type="text" tabindex="1" maxlength="11"  required pattern="^[0-9]{9}[vV]$" class=""/>
